...
class CompareProducts(unittest.TestCase):
    ...
    def test_compare_products_removal_alert(self):
        ...
        # wait for Add to Compare link to be visible
        Add_to_Compare = WebDriverWait(self.driver, 10)\
            .until(expected_conditions.visibility_of_element_located((By.LINK_TEXT, 'Add to Compare')))
