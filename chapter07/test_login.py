...
class LoginTests(unittest.TestCase):
    def setUp(self):
        app = ('/Users/Chuck/lpthw/appium_ex/appium-ios-basic-master/final/build/Release-iphonesimulator/AppiumTest.app')
    ...
    def test_02_PasswordField(self):
    ...
    def test_03_Login(self):
            self.test_01_EmailField()
            self.test_02_PasswordField()
            ...
            self.assertTrue(smiley.get_attribute('visible'))
